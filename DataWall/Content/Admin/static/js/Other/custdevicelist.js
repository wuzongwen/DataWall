layui.use(['laydate', 'form', 'jquery', 'admin'], function () {
    ...
    window.member_stop = function (obj, id) {
        ...
        layer.confirm('确认要' + title + '吗？', function (index) {
            ...
            $.ajax({
                type: 'post',
                url: '/Other/CustDeviceEditEnable',
                dataType: 'json',
                data: {
                    id: id,
                    enable: enable
                    ...
                    switch (code) {
                        case '200':
                            layer.alert(msg.msg, { icon: 1 }, function () {
                                location.href = "/Other/CustDeviceList?page=" + msg.page + "&Type=" + type;
                            });
                            break;
                        case '201':
                            layer.msg(msg.msg);
